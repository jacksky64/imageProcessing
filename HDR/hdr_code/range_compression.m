function [res] = range_compression(im, filt_type, s_sat, bbeta, aalpha, ifsharp)

% [res] = range_compression(im, filt_type(optional), s_sat(optional), 
