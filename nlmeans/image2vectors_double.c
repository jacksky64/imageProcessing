...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) {
    ...
    //mexPrintf("mex 0: Isize[0]=%d Isize[1]=%d Isize[2]=%d\n", Isize[0],Isize[1],Isize[2]); 
    ...
    if(image3D==0) {
        ...
        //mexPrintf("mex 1: kernelsize=%d Isize[2]=%d  block_size[0]=%d  block_size[1]=%d\n", kernelsize,Isize[2],block_size[0],block_size[1]); 
    }
    else {
        block[0]=kernelratio;
        block[1]=kernelratio;
        ...
        //mexPrintf("mex 11: kernelsize=%d block_size[0]=%d  block_size[1]=%d block_size[2]=%d\n", kernelsize,block_size[0],block_size[1],block_size[2]); 
   }
    
     //mexPrintf("mex 1: Vsize[0]=%d  Vsize[1]=%d\n", Vsize[0], Vsize[1]); 
